...
const SearchResult: FC = (): JSX.Element => {
  ...
  return (
    <section
      className={`fixed top-0 left-0 right-0 w-full h-screen overflow-hidden bg-white transition-opacity duration-300 lg:w-[350px] lg:h-auto lg:rounded-lg lg:top-20 lg:shadow-md lg:left-1/2 lg:right-1/2 lg:translate-x-[80px] xl:w-[400px] xl:translate-x-[101px] ${
